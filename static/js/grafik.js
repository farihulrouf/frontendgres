...
var bulan_seleksi = [],
  nilai_pagu_seleksi = [],
  metode_jumlah_seleksi = [],
  nilai_kontrak_seleksi = [],
  nilai_hps_seleksi = [];
//console.log('tester')
...
var bulan_langsung = [],
  nilai_pagu_langsung = [],
  metode_jumlah_langsung = [],
  nilai_konrak_langsung = [],
  nilai_hps_langsung = [];
//console.log('tester')
...
var bulan_purchase = [],
  nilai_pagu_purchase = [],
  metode_jumlah_purchase = [],
  nilai_kontrak_purchase = [],
  nilai_hps_urchase = [];
//console.log('tester')
...
var bulan_kecuali = [],
  nilai_pagu_kecuali = [],
  metode_jumlah_kecuali = [],
  nilai_kontrak_kecuali = [],
  nilai_hps_kecuali = [];
//console.log('tester')
